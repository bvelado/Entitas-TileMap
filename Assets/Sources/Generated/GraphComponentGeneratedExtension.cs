namespace Entitas {
    public partial class Entity {
        ...
        public Entity AddGraph(System.Collections.Generic.Dictionary<Entitas.Entity, Entitas.Entity[]> newGraph) {
        ...
        public Entity ReplaceGraph(System.Collections.Generic.Dictionary<Entitas.Entity, Entitas.Entity[]> newGraph) {
            var componentPool = GetComponentPool(ComponentIds.Graph);
            var component = (GraphComponent)(componentPool.Count > 0 ? componentPool.Pop() : new GraphComponent());
            component.graph = newGraph;
    ...
    public partial class Pool {
        ...
        public Entity SetGraph(System.Collections.Generic.Dictionary<Entitas.Entity, Entitas.Entity[]> newGraph) {
            if (hasGraph) {
